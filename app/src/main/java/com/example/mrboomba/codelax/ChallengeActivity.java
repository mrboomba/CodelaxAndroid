...
public class ChallengeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        call.enqueue(new Callback<ChallengeResponse>() {
            ...
            public void onResponse(Call<ChallengeResponse> call, Response<ChallengeResponse> response) {
                ...
                Picasso.with(ChallengeActivity.this).load(Config.SERVER + "api/challenge/pic/" + num[0]).resize(900, 900).into(pic);
                        ...
                        choice[i].setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                bg2.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View view) {
                                        Intent intent = new Intent(ChallengeActivity.this, ChallengeActivity2.class);
    ...
    public void onBackPressed() {
        ...
        answer[3]="";
        answer[4]="";
        Match match = new Match(username,rival,num,answer,0);
        ApiInterface apiService =
                ApiClient.getClient().create(ApiInterface.class);
        ...
        call.enqueue(new Callback<Match>() {
            ...
            public void onFailure(Call<Match> call, Throwable t) {
                Toast.makeText(ChallengeActivity.this, "Check your connection", Toast.LENGTH_SHORT).show();
            }
