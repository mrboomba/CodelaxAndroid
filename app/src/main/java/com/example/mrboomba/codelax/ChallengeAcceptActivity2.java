...
public class ChallengeAcceptActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<ChallengeResponse> call = apiService.getChallenge(num[1]);
        call.enqueue(new Callback<ChallengeResponse>() {
            ...
            public void onResponse(Call<ChallengeResponse> call, Response<ChallengeResponse> response) {
                ...
                Picasso.with(ChallengeAcceptActivity2.this).load(Config.SERVER + "api/challenge/pic/" + num[1]).resize(450, 500).into(pic);
                    ...
                    if (check != i) {
                        ...
                        choice[i].setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                answer[1] = String.valueOf(choice[finalI].getText());

                                setContentView(bg);
                                bg2.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View view) {
                                        Intent intent = new Intent(ChallengeAcceptActivity2.this, ChallengeAcceptActivity3.class);
                ...
                choice[check].setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        mCountDownTimer = null;
                        choice[check].setBackgroundColor(ResourcesCompat.getColor(getResources(), R.color.green, null));
                        answer[1] = String.valueOf(choice[check].getText());
                        setContentView(bg);
                        bg2.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
    ...
    public void onBackPressed() {
        ...
        call.enqueue(new Callback<Match>() {
            ...
            public void onFailure(Call<Match> call, Throwable t) {
                Toast.makeText(ChallengeAcceptActivity2.this, "Check your connection", Toast.LENGTH_SHORT).show();
            }
