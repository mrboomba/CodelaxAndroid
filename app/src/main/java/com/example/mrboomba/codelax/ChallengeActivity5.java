...
public class ChallengeActivity5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        call.enqueue(new Callback<ChallengeResponse>() {
            ...
            public void onResponse(Call<ChallengeResponse>call, Response<ChallengeResponse> response) {
                ...
                Picasso.with(ChallengeActivity5.this).load(Config.SERVER+"api/challenge/pic/"+num[4]).resize(450,500).into(pic);
                                    ...
                                    public void onClick(View view) {
                                        ...
                                        call.enqueue(new Callback<Match>() {
                                            ...
                                            public void onFailure(Call<Match> call, Throwable t) {
                                                Toast.makeText(ChallengeActivity5.this, "Check your connection", Toast.LENGTH_SHORT).show();
                                            }
