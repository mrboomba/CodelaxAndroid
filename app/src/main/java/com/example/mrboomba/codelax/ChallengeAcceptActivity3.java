...
public class ChallengeAcceptActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<ChallengeResponse> call = apiService.getChallenge(num[2]);
        call.enqueue(new Callback<ChallengeResponse>() {
            ...
            public void onResponse(Call<ChallengeResponse>call, Response<ChallengeResponse> response) {
                ...
                Picasso.with(ChallengeAcceptActivity3.this).load(Config.SERVER+"api/challenge/pic/"+num[2]).resize(450,500).into(pic);
                    ...
                    if(check!=i){
                        ...
                        choice[i].setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                answer[2] = String.valueOf(choice[finalI].getText());

                                bg2.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View view) {
                                        Intent intent = new Intent(ChallengeAcceptActivity3.this, ChallengeAcceptActivity4.class);
                ...
                choice[check].setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        mCountDownTimer=null;
                        choice[check].setBackgroundColor(ResourcesCompat.getColor(getResources(),R.color.green,null));
                        answer[2] = String.valueOf(choice[check].getText());
                        setContentView(bg);
                        bg2.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
    ...
    public void onBackPressed() {
        ...
        call.enqueue(new Callback<Match>() {
            ...
            public void onFailure(Call<Match> call, Throwable t) {
                Toast.makeText(ChallengeAcceptActivity3.this, "Check your connection", Toast.LENGTH_SHORT).show();
            }
