...
public class ChallengeAcceptActivity5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<ChallengeResponse> call = apiService.getChallenge(num[4]);
        call.enqueue(new Callback<ChallengeResponse>() {
            ...
            public void onResponse(Call<ChallengeResponse>call, Response<ChallengeResponse> response) {
                ...
                Picasso.with(ChallengeAcceptActivity5.this).load(Config.SERVER+"api/challenge/pic/"+num[4]).resize(450,500).into(pic);
                    ...
                    if(check!=i){
                        ...
                        choice[i].setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                answer[4] = String.valueOf(choice[finalI].getText());
                                bg.bringToFront();
                                setContentView(bg);
                                bg2.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        ...
                                        final String username = sharedPref.getString("username", defaultValue);
                                        Match match = new Match(rival,username,answer,point);
                                        ApiInterface apiService =
                                                ApiClient.getClient().create(ApiInterface.class);
                                        ...
                                        call.enqueue(new Callback<Match>() {
                                            ...
                                            public void onResponse(Call<Match> call, Response<Match> response) {
                                                ...
                                                Intent intent = new Intent(ChallengeAcceptActivity5.this, ResultActivity.class);
                                                intent.putExtra("check","false");
                                                intent.putExtra("user",rival);
                                                intent.putExtra("rival",username);
                                                startActivity(intent);
                                            }

                                            @Override
                                            public void onFailure(Call<Match> call, Throwable t) {
                                                Toast.makeText(ChallengeAcceptActivity5.this, "Check your connection", Toast.LENGTH_SHORT).show();
                                            }
                ...
                choice[check].setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        mCountDownTimer=null;
                        choice[check].setBackgroundColor(ResourcesCompat.getColor(getResources(),R.color.green,null));
                        answer[4] = String.valueOf(choice[check].getText());
                        setContentView(bg);
                        bg2.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
