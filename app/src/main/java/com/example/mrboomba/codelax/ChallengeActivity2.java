    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        call.enqueue(new Callback<ChallengeResponse>() {
            ...
            public void onResponse(Call<ChallengeResponse> call, Response<ChallengeResponse> response) {
                ...
                Picasso.with(ChallengeActivity2.this).load(Config.SERVER + "api/challenge/pic/" + num[1]).resize(450, 500).into(pic);
                        ...
                        choice[i].setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                bg2.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View view) {
                                        Intent intent = new Intent(ChallengeActivity2.this, ChallengeActivity3.class);
    ...
    public void onBackPressed() {
        ...
        call.enqueue(new Callback<Match>() {
            ...
            public void onFailure(Call<Match> call, Throwable t) {
                Toast.makeText(ChallengeActivity2.this, "Check your connection", Toast.LENGTH_SHORT).show();
            }
